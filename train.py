...
#from MiniImagenet_augment import MiniImagenet
...
if __name__ == '__main__':
    ...
    if (not os.path.exists("ckpt")):
        os.mkdir("ckpt")
    mdl_file = 'ckpt/compare%d%d_unsup.mdl'%(n_way, k_shot)
...
# 		net.load_state_dict(torch.load(mdl_file))
    ...
    mini = MiniImagenet('/home/atik/Documents/UMAML_FSL/data/unsupervised/', 
                      mode='train', n_way=n_way, k_shot=k_shot, k_query=k_query,
		                    batchsz=1000, resize=224)
    
    mini_val = MiniImagenet('/home/atik/Documents/UMAML_FSL/data/', 
