...
def main():
    ...
    mini_train = MiniImagenet(path, mode='train', n_way=5, k_shot=1,
                        k_query=1,
                        batchsz=10000, resize=84)
    mini_test = MiniImagenet(path, mode='test', n_way=5, k_shot=1,
                             k_query=1,
    ...
    for epoch in tqdm(range(epochs)):
        ...
        db = DataLoader(mini_train, batch_size=4, shuffle=True, num_workers=0, pin_memory=True)
        ...
        for step, (x_spt, y_spt, x_qry, y_qry) in enumerate(db):
            ...
            if step % 1000 == 0:  # evaluation
                db_test = DataLoader(mini_test, batch_size=1, shuffle=True, num_workers=0, pin_memory=True)
                accs_all_test = []
